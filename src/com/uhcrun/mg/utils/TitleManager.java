...
public class TitleManager {
	...
	public static final void senTitle(Player player, String msgTitle, String msgSubTitle, int ticks){
		...
		sendTimer(player, ticks);
	}
	
	public static final void sendTimer(Player player, int ticks){
